        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{route('login')}}" >
                ...
                <div class="mb-5">
                    ...
                    <label for="remember" class="text-gray-500 font-bold">Recuérdame</label>
                </div>
                <button type="submit" value="Iniciar sesión" class="bg-blue-500 hover:bg-blue-600 transition-colors cursor-pointer text-white px-4 py-3 rounded font-medium w-full">Log In</button>
                </div>
            </form>
        </div>
    </div>
